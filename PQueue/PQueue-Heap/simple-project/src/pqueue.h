...
// TODO: Fill in the rest of the private section 
   ...
   //Checks the parents of index and swaps if parent priority is less
   void rearrangeUp(int index);
   //Checks the children of current index and swaps if child priority is greater
   void rearrangeDown(int index);

   //Swaps the elements in index and indexToSwapWith in heap array
   void swapPosition(int index, int indexToSwapWith);
