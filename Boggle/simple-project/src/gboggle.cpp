...
const std::string CUBE_FONT = "Helvetica";  /* Font for letters on cube face      */
const double FONT_PERCENTAGE = 0.6;    /* percentage of cube used for letter */
const std::string SCORE_FONT = "Helvetica"; /* Font for scoreboard names & scores */
const int SCORE_FONT_SIZE = 18;
const int WORD_FONT_SIZE = 10;

#ifdef _MSC_VER
const std::string WORD_FONT = "Arial";
#else
const std::string WORD_FONT = "Geneva";
#endif

const std::string BOARD_COLOR = "#FFEE66";
const std::string DIE_COLOR = "#E6E6E6";
const std::string LETTER_COLOR = "#023BD6";
const std::string WORD_COLOR = "#02805D";
const std::string LABEL_COLOR = "#028040";
...
static void fillBox(double x, double y, double width, double height, std::string color);
static void drawAndFillRoundedRect(double x, double y, double width, double height, double r, std::string color);
static void drawCenteredChar(double centerX, double centerY, char ch, std::string color);
static void drawCube(int row, int col, char ch, bool invert);
static double cubeX(int col);
static double cubeY(int row);
static void drawPlayerLabel(Player player, std::string name);
...
static void calculateGeometry(int numRows, int numCols) {
   double boardSize = std::min(gwp->getWidth()/3, gwp->getHeight() - LABEL_HEIGHT);
   gState.cubeSize = std::min((boardSize-BOARD_BORDER)/numRows,
...
static void drawCenteredChar(double xc, double yc, char ch, std::string color) {
   std::string s(1, ch);
   GLabel label(std::string(1, ch));
   label.setFont(CUBE_FONT + "-" + integerToString(int(gState.fontSize)));
...
static void drawAndFillRoundedRect(double x, double y, double width,
                                   double height, double r, std::string color) {
